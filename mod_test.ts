...
import {
  ...
  import { bold, gray, green, red, stripColor, yellow, AssertionError, equal } from "./deps.ts";
  ...
  Deno.test("ArrayContains", function () {
    ...
    throws(
      () => arrayIncludes(fixtureObject, [{ deno: "node" }]),
      AssertionError,
      `Expected actual: "[
  {
    deno: "luv"
...
missing: [
  ...
  Deno.test("AssertObjectMatching", function () {
    ...
    throws(
      () => objectMatch(m, { bar: [/abc/m, /abc/g] }),
      AssertionError,
    );
    //Built-in data structures
    throws(
      () => objectMatch(n, { foo: new Set(["baz"]) }),
      AssertionError,
    );
    throws(
      () => objectMatch(n, { bar: new Map([["bar", 3]]) }),
      AssertionError,
    );
    throws(
      () => objectMatch(n, { baz: new Map([["a", { baz: true }]]) }),
      AssertionError,
    );
  });
...
-     b: 2
  ...
  Deno.test({
    ...
    fn() {
      throws(
        () => strictEquals({ a: 1 }, { a: 1 }, "CUSTOM MESSAGE"),
        AssertionError,
  ...
  Deno.test("assert almost equals number", () => {
    ...
    throws(
      () => almostEquals(0.1 + 0.2, 0.3, 1e-17),
      AssertionError,
      `Expected actual: "${
        (
          0.1 + 0.2
  ...
  Deno.test({
    ...
    fn() {
      ...
      throws(
        () => instanceOf(new TestClass1(), TestClass2),
        AssertionError,
      ...
      // Custom message
      throws(
        () => instanceOf(new Date(), RegExp, "Custom message"),
        AssertionError,
        "Custom message",
      );
      ...
      throws(
        () => instanceOf(Object.create(null), TestClass1),
        AssertionError,
        `Expected object to be an instance of "TestClass1" but was "Object".`,
      );
...
+     ccccccccccccccccccccccc: 1
  ...
  Deno.test("Assert Is Error with custom Error", () => {
    ...
    throws(
      () => isError(new AnotherCustomError("failed"), CustomError, "fail"),
      AssertionError,
      'Expected error to be instance of "CustomError", but was "AnotherCustomError".',
    );
  });
